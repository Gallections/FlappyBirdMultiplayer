...
public class FlappyBird extends JPanel implements ActionListener, KeyListener {
    ...
    int yogyaX = boardWidth / 4;
    int yogyaY = boardHeight / 2;
    int yogyaWidth = 50;
    int yogyaHeight = 35;
    ...
    int yVelocityY = 0;
    int yGravity = 1;
    int yVelocityX = -4; // when the pipes move to the left
    ...
    FlappyBird() {
        ...
        birdImg = new ImageIcon(getClass().getResource("./yellow.png")).getImage();
        topPipeImg = new ImageIcon(getClass().getResource("./toppipe.png")).getImage();
        bottomPipeImg = new ImageIcon(getClass().getResource("bottompipe.png")).getImage();
        yogyaImg = new ImageIcon(getClass().getResource("./gray.png")).getImage();
...
//        gameloop.start();
    ...
    public void draw(Graphics g) {
        ...
        if (gameOver) {
            ...
            g.drawString("Collaboration Score: "+ String.valueOf((int) score), 10, 60);
    ...
    public void move() {
        ...
        for(int i =0; i < pipes.size(); i++) {
            ...
            if(!pipe.passed && bird.x > pipe.x + pipe.width) {
                pipe.passed = true;
//                playerOneScore += 0.5; // two pipes adding up.
            }
    ...
    public void yogyaMove() {
        // bird
        yVelocityY += yGravity; // velocity will slow down consistently
        yogya.y += yVelocityY;
...
//            pipe.x += yVelocityX;
    ...
    public void createStartGameButton(FlappyBird model) {
        JButton startButton = new JButton("Start Game");
        startButton.setBounds(130, 145, 100, 50);
    ...
    public void createRetryButton(FlappyBird model) {
        JButton retryButton = new JButton("Retry");
        retryButton.setBounds(130, 245, 100, 50);
        retryButton.setForeground(Color.WHITE);
        retryButton.setBackground(Color.BLUE);
        retryButton.setBorder(BorderFactory.createLineBorder(Color.BLACK));

        model.add(retryButton);

        retryButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                model.remove(retryButton);
